...
if __name__ == "__main__":
    uthmani_aba = Path("../website/data/scripts/db/uthmani-aba.db")
    uthmani_wbw = Path("../website/data/scripts/db/uthmani-wbw.db")
    uthmani_s_aba = Path("../website/data/scripts/db/uthmani-simple-aba.db")
    uthmani_s_wbw = Path("../website/data/scripts/db/uthmani-simple-wbw.db")
